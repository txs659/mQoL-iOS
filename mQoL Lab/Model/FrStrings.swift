...
class FrStrings {
    ...
    static let view_lab_consent_chkbox_1 = "J\'affirme avoir pris connaissance et accepte sans réserve les conditions d\'utlisation de cette application."
    static let view_lab_consent_email_agree = "1. Vous avez l\'option de télécharger ce formulaire de consentement."
