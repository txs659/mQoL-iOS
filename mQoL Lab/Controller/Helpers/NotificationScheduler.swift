...
class NotificationScheduler {
    ...
    private func scheduleRandomEvents() {
        ...
        for (surveyNumber, info) in randomInfo {
            ...
            let randomDays = surveyInfo["days"] as! [String : Any]
            let randomSurveyInfo = surveyInfo["info"] as! [String : Any]
                    ...
                    for randomNum in 1...numberOfPrompts {
                        ...
                        if language == "fr" {
                            ...
                            manager.notifications.append(surveyNotification(
                                id: "\(surveyNumber)-randomDay\(day)Num\(randomNum)",
